                ...
                <div class="aa">
                    <div class="a2">
                        <ul>
                            ...
                            <li><label>비밀번호 확인</label><br><input type="password" id="PWchk" size="43" placeholder=" 8~16자 영문 대 소문자, 숫자, 특수문자"required></li><br>
                            <li><label>이름</label><br><input type="name" name="userName" id="name" size="43"required></li><br>
                            <li>							
                                <label>성별</label><br>
                                <label class="btn btn-primary active">
                                    <input type="radio" name="userGender" autocomplete="off" value="남자" checked><span>남자</span>
                                </label>
                                <label class="btn btn-primary active">
